...
const Home = () => {
  ...
  return (
    <div className="flex flex-col w-full bg-slate-50 dark:bg-slate-950 overflow-hidden transition-colors duration-300">
      {/* Hero Section */}
      ...
      <section className="py-24 bg-white dark:bg-slate-900 relative z-30 transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              ...
              <motion.div 
                ...
                whileHover={{ y: -5 }}
                className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-xl dark:hover:shadow-slate-900 transition-all duration-300 flex flex-col relative overflow-hidden group"
              >
      ...
      <section className="relative z-40 py-16 px-6 bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
        <div className="w-full max-w-7xl mx-auto">
          <div className="bg-slate-900 rounded-3xl shadow-2xl p-10 md:p-14 border border-slate-800">
      ...
      <section className="py-16 bg-white dark:bg-slate-900 relative z-30 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div className="flex flex-wrap gap-4">
              {[
                ...
                { title: "304L", sub: "304L Stainless Steel" }, { title: "310", sub: "310 Stainless Steel" },
                { title: "310S", sub: "310S Stainless Steel" }, { title: "316", sub: "316 Stainless Steel" },
                { title: "316L", sub: "316L Stainless Steel" }, { title: "409", sub: "409 Stainless Steel" },
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 flex flex-col relative transition-colors duration-300"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div 
                ...
                className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden hover:shadow-xl dark:hover:shadow-slate-900 transition-all duration-300 flex flex-col group cursor-pointer"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div 
                ...
                className="bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl p-8 flex flex-col transition-colors duration-300"
              >
                <div className="flex gap-1 text-[#ff5722] mb-6">
                  {[1,2,3,4,5].map(star => <span key={star}>★</span>)}
                </div>
                <p className="text-slate-700 dark:text-slate-300 italic mb-8 flex-1 transition-colors">"{testimonial.quote}"</p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#ff5722]/20 text-[#ff5722] rounded-full flex items-center justify-center">
                    <Globe size={18} />
                  </div>
